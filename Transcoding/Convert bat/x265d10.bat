...
echo src=core.std.Trim(src,107765,133416) >> "%~dpn1.vpy"
echo BM3D=mvf.BM3D(src,sigma=[8,0,0],radius1=0,profile1="lc") >> "%~dpn1.vpy"
echo BM3D.set_output() >> "%~dpn1.vpy"

Echo Building File Index......

"C:\Program Files (x86)\VapourSynth\core64\vspipe.exe" --y4m "%~dpn1.vpy" - | "C:\Program Files (x86)\MeGUI-2715-32\tools\x265\x64\x265.exe" --y4m --preset slow --frame-threads 7 --crf 20 --deblock 1:0 -D 10 --merange 44 --aq-strength 0.8 --qcomp 0.65 --output "D:\Media\TEMP\%~n1_2.mkv" -
